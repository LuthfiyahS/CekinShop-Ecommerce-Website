...
if ($find && mysqli_num_rows($qu) > 0) {
    ...
    if ($querycrud) {
        echo "<script language=javascript> window.alert('Memasukan data kekeranjang Berhasil'); window.location='../../user/barang.php?id=CTL0001';</script>";
    } else {
        echo "<script language=javascript> window.alert('Memasukan data kekeranjang Gagal'); window.location='../../user/barang.php';</script>";
    }
}
